...
Furthermore, the article analyse strategies and approaches to promote
...
2009b; Science Staff 2011). The term Open Research Data can be applied
...
The vision of the High Level Expert Group on Scientific Data
commissioned in 2010 by the European Commission is that, in year 2030
and in their role as data user, scientists “are able to find, access and
process the data they need”, and in their role as data producer “prefer
to deposit their data with confidence in reliable repositories” (High
...
conditions must be defined. Murray-Rust et al. (see [Panton
Principles](http://pantonprinciples.org)) for example demands
...
the 1140 of those questioned, 87% contradicted the statement that “there
...
more than 1300 researchers pointed to a “lack of access to data
...
Wicherts et al. (2006) in psychology and Savage & Vickers (2009) in
...
basic data of the articles. Despite the clear demands for open access to
...
the status of Data Sharing is brought by the analysis of Campbell et al.
(2002) in genetics. In this study that involved about 1800 life science
...
development and to maximize the benefit to society” (Smith & Carrano
...
description of them in a peer reviewed article.[^2] Alongside Data
...
caused more than 4000[^3] people to fall ill in Germany in 2011. The
publication of sequence data under a Creative Commons licence and the
use of the widely popular GitHub[^4] as an exchange platform enabled
...
they handle research data.[^6] Recommendations and mandatory
...
publication. The National Institute of Health (NIH) was pioneer in this
...
Data Sharing[^7]. From 2011 on, the National Science Foundation (NSF)
...
repositories" (see [Guide to Publication Policies of the
Nature Journals](<http://www.nature.com/authors/gta.pdf>)).

It must be noted that implementation of the requirements formulated in
the data policies will not run by itself (Pampel & Bertelmann 2011). To
...
Surveys carried out by Kuipers & Van der Hoeven (2009) and Tenopir et
...
the Research Data Management term[^8]. The aim is to build on
...
competing with many other projects on the researchers priority list.
...
Osswald & Strathmann 2012; Reilly 2012).

Van der Graaf & Waaijers (2011) have formulated four central fields of
...
Data Sharing (1); in addition, the schooling and training of scientists
...
challenge of the on going financing of these infrastructures (4).
...
al. 2012)[^10], the second named data paper strategy has been gaining
more and more attention recently. Chavan & Penev (2011) define this
...
made, among others, in the geosciences[^11] and ecology[^12]. The use of
...
repository” (Pfeiffenberger & Carlson 2011). The data sets and
...
2011), it is possible to link publications and the data they are based
on in a comprehensive form. This procedure also supports the visibility
of the data. Some publishing houses, for example, have therefore already
integrated freely accessible research data in their platforms (Reilly et
al. 2011). A number of data journals have been brought into being in the
meantime.[^13] It must be noted here that the establishment of data
journals is only feasible when data, metadata and the corresponding text
publication are freely accessible, as only then can a barrier free
re-use of the data be possible.

The networking of articles and data is also followed in the third named
enriched publication strategy (Woutersen-Windhouwer et al. 2009). The
aim here is to relate all relevant information objects around an article
and to support their technical networking, so that a knowledge space is
created, in which the research data that are the basis of the article
can be made freely accessible.[^14]
...
research.[^15] A look at the access conditions of repositories
...
2007; Botstein 2010), astronomy (Henneken & Accomazzi 2011; Dorch 2012)
...
disciplines is met my new strategies that work on barriers such as the
...
context, great significance must be given to the structuring and
...
EU-project [Opportunities for Data Exchange (ODE)](http://ode-project.eu). This model takes the various players
involved (policy-makers, funders, researchers, research and education
organisations, data management and infrastructure service providers and
...
society[^16] and academic policy (Kroes 2012), as is assumed, for
...
Declaration” (2003) makes it clear, however, that further steps are
...
Cravedi, K., 2008. GenBank Celebrates 25 Years of Service with TwoDay
...
Kuipers, T. & Hoeven, van der, J., 2009. *Insight into digital
...
[^2]: See also the Fort Lauderdale Principles (Wellcome Trust 2003) and the Toronto Statement (Birney et al. 2009).

[^3]: See: <http://www.rki.de/DE/Content/Service/Presse/Pressemitteilungen/2011/11_2011.html> (Retrieved 20 August 2012).

[^4]: GitHub is a hosting service for the collaborative development of software. See: <https://github.com/ehec-outbreak-crowdsourced> (Retrieved 20 August 2012).

[^5]: ICSU World Data System: <http://icsu-wds.org/images/files/WDS_Certification_Summary_11_June_2012_pdf>

[^6]: For details see: Pampel & Bertelmann (2011).

[^7]: National Institutes of Health: <http://grants.nih.gov/grants/guide/notice-files/NOT-OD-03-032.html>

[^8]: For details see: Büttner et al. (2011) and Pryor (2012).

[^9]: The following categorization is based on Dallmeier-Tiessen (2011).

[^10]: For the GenBank history see: Cravedi (2008).

[^11]: The AGU Journals have published data papers for many years. See: <http://www.agu.org/pubs/authors/policies/data_policy.shtml> (Retrieved 20 August 2012).

[^12]: See the Data Papers of the Journals Ecological Archives of the Ecological Society of America (ESA): <http://esapubs.org/archive archive_D.htm> (Retrieved 20 August 2012).

[^13]: Examples: Atomic Data and Nuclear Data Tables (Elsevier); Biodiversity Data Journal (Pensoft Publishers); Dataset Papers in Biology (Hindawi Publishing Corporation); Dataset Papers in Chemistry (Hindawi Publishing Corporation); Dataset Papers in Ecology (Hindawi Publishing Corporation); Dataset Papers in Geosciences (Hindawi Publishing Corporation); Dataset Papers in Materials Science (Hindawi Publishing Corporation); Dataset Papers in Medicine (Hindawi Publishing Corporation); Dataset Papers in Nanotechnology (Hindawi Publishing Corporation); Dataset Papers in Neuroscience (Hindawi Publishing Corporation); Dataset Papers in Pharmacology (Hindawi Publishing Corporation); Dataset Papers in Physics (Hindawi Publishing Corporation); Earth System Science Data - ESSD (Copernicus Publications); Geoscience Data Journal (Wiley); GigaScience (BioMed Central); Nuclear Data Sheets (Elsevier); Open Archaeology Data (Ubiquity Press); Open Network Biology (BioMed Central). Please note that the majority of the journals are still developing and a narrow definition of the type of publication is difficult because of this early development stage.

[^14]: Potential offered by this strategy under use of Linked Open Data.

[^15]: An overview of existing data repositories is offered by Databib (<http://databib.org>) and re3data.org (<http://re3data.org>).

[^16]: See here, for example, the Vision of the Open Knowledge Foundation (OKF): <http://okfn.org/about/vision/> (Retrieved 20 August 2012).
